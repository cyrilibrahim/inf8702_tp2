...
namespace Math3D
{
    ...
    inline const CVecteur3 CVecteur3::Refract( const CVecteur3& Vecteur, const CVecteur3& Normal, const REAL IndiceRefractionRatio )
    {
        ...
        REAL Cos2Sq = ( RENDRE_REEL( 1.0 ) - ( IndiceRefractionRatio * IndiceRefractionRatio ) *
            ( RENDRE_REEL( 1.0 ) - ( Cos1 * Cos1 ) ) );
        ...
        else
        {
            ...
            Result = IndiceRefractionRatio * Vecteur - ( ( sqrt( Cos2Sq ) - ( IndiceRefractionRatio * Cos1 ) ) * Normal );
        }
